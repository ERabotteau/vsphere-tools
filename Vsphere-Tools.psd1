#
# Manifeste de module pour le module « Vsphere-Tools »
#
# Généré par : rabotteau
#
# Généré le : 14/03/2017
#

@{

# Module de script ou fichier de module binaire associé à ce manifeste
RootModule = 'Vsphere-Tools.psm1'

# Numéro de version de ce module.
ModuleVersion = '1.0'

# ID utilisé pour identifier de manière unique ce module
GUID = '3dcb4c18-05d5-410a-a97d-2ba954fbc0d8'
...
Copyright = '(c) 2017 rabotteau. All rights reserved.'

# Description de la fonctionnalité fournie par ce module
Description = 'Outils Vsphere'
